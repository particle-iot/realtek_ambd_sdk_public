...
#ifndef _HAL_8721D_PINMUX_DEFINES_
#define _HAL_8721D_PINMUX_DEFINES_
...
/** @defgroup PINMUX_PAD_Control_definitions 
  * @{
  */
#define PAD_BIT_SHUT_DWON					(1U << 15)		
#define PAD_BIT_SDIO_H3L1					(1U << 14)
#define PAD_BIT_PULL_RESISTOR_SEL			(1U << 13)				
#define PAD_BIT_SCHMITT_TRIGGER_EN		(1U << 12)	
#define PAD_BIT_PULL_RESISTOR_SMALL		(1U << 11) /* for PAD C/F/G */
#define PAD_BIT_SHIFT_DRIVING_STRENGTH	10	
#define PAD_BIT_MASK_DRIVING_STRENGTH	0x03				
#define PAD_BIT_PULL_DOWN_RESISTOR_EN	(1U << 9)				
#define PAD_BIT_PULL_UP_RESISTOR_EN		(1U << 8)
...
#define PINMUX_FUNCTION_KEYSCAN_COL		(30)PAD_BIT_MASK_FUNCTION_ID
...
#endif // _HAL_8721D_PINMUX_DEFINES_
