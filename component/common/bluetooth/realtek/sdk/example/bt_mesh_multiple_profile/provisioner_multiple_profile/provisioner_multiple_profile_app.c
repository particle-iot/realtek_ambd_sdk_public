...
#if ((defined(CONFIG_BT_MESH_PERIPHERAL) && CONFIG_BT_MESH_PERIPHERAL) || \
    (defined(CONFIG_BT_MESH_SCATTERNET) && CONFIG_BT_MESH_SCATTERNET))
extern uint8_t le_adv_start_enable;
...
void bt_mesh_provisioner_multiple_profile_app_vendor_callback(uint8_t cb_type, void *p_cb_data)
{
    ...
    APP_PRINT_INFO1("bt_mesh_provisioner_multiple_profile_app_vendor_callback: command 0x%x", cb_data.p_gap_vendor_cmd_rsp->command);
    switch (cb_type)
    {
