This m4a example is used to play m4a files from the SDCARD. In order to run the example the following steps must be followed.
	...
	1. Set the parameter CONFIG_EXAMPLE_AUDIO_M4A_MP3 to 1 in platform_opts.h file
	
	2. Set the parameter configTOTAL_HEAP_SIZE to 210*1024 in FreeRTOSConfig.h
	
	3. Enable SDRAM Heap in heap_5.c

	3. In the example file "example_audio_m4a_mp3.c" set the config parameters in the start of the file
