...
4. In IAR, you need to include lib_haac.a under "km4_application/lib" and example_audio_helix_aac.c file in this folder under "km4_application/utilities/example".
