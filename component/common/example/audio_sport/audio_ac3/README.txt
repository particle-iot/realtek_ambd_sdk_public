This ac3 example is used to play ac3 files from the SD card. In order to run the example the following steps must be followed.
	...
	3. Parameters should be configured in /component/audio/a52dec/src/a52dec.c
...
[Compilation Tips]
	...
	3. In IAR, you need to include lib_ac3.a under "km4_application/lib" and .c file in this folder under "km4_application/utilities/example"